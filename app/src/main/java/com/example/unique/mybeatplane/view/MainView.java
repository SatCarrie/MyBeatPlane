package com.example.unique.mybeatplane.view;
...
import com.example.unique.mybeatplane.constant.ConstantUtil;
...
import com.example.unique.mybeatplane.sounds.GameSoundPool;
...
public class MainView extends BaseView{
	...
	private int sumScore1=1050;			// 游戏总得分
	private int sumScore=1050;
...
//		bulletGoods.setScreenWH(screen_width, screen_height);
	...
	public void initBitmap() {
		...
		background = BitmapFactory.decodeResource(getResources(), R.drawable.sea1);
		background2 = BitmapFactory.decodeResource(getResources(), R.drawable.sea1);
				...
				if(obj.isAlive()){
					...
					if(obj.isCanCollide() && myPlane.isAlive()){
						if(obj.isCollide(myPlane)){
							if(obj.getScore()<sumScore) {
								addGameScore(obj.getScore());
								obj.attacked(obj.getScore());
							}
							else{
...
*/
	...
	public void addGameScore(int score){
		middlePlaneScore += missileScore;	// 中型敌机的积分
...
//		bulletScore += score;		// 子弹的积分
	...
	public void change(){
		if(sumScore>=1000000&&sumScore1<1000000){
			myPlane.drawSelf2(canvas);
		}
		else if(sumScore>=500000&&sumScore1<500000){

			myPlane.drawSelf2(canvas);
		}
		else if(sumScore>=100000&&sumScore1<100000){

			myPlane.drawSelf2(canvas);
		}
		else if(sumScore>=10000&&sumScore1<10000){
			myPlane.drawSelf2(canvas);
		}
		else if(sumScore>=8100&&sumScore1<8100){
			myPlane.drawSelf2(canvas);
		}
		else if(sumScore>=2100&&sumScore1<2100){
			myPlane.drawSelf2(canvas);
		}
		else if(sumScore>=1100&&sumScore1<1100){
			myPlane.drawSelf2(canvas);
		}
	}

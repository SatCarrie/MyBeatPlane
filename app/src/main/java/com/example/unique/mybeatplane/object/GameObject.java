...
abstract public class GameObject {
	...
	protected float new_object_width; 	// 对象的宽度
	protected float new_object_height; 	// 对象的高度
	...
	public int getMyfenshu(){return myfenshu;}
	public void setMYfenshu(int fen){myfenshu=fen;}
}
